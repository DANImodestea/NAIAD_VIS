...
def main():
    ...
    while running:
        ...
        if not paused:
            ...
            lon, lat, timestamp = path[frame - 1] if frame > 0 else path[0]
            x, y = latlon_to_screen(lat, lon)
            pygame.draw.circle(screen, (255, 0, 0), (x, y), 6)
        ...
        # --- Draw Buttons ---
        draw_button(screen, "Pause", WINDOW_WIDTH - BUTTON_WIDTH - 10, 10, BUTTON_WIDTH, BUTTON_HEIGHT, (0, 0, 255), font)
        draw_button(screen, "Replay", WINDOW_WIDTH - BUTTON_WIDTH - 10, 70, BUTTON_WIDTH, BUTTON_HEIGHT, (0, 255, 0), font)
